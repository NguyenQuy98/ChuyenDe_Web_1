...
<main>
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8">
                <form method="POST" role="form" action="{{route('flight-book')}}">
                    @csrf
                        ...
                        <div>
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item list-group-item-info">
                                    ...
                                    <div class="pull-right">
                                        <strong name="price" value="IDR24.796.650,00">IDR24.796.650,00</strong>
                                    </div>
                                    <div class="clearfix"></div>
                                </li>
                            </ul>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <input type="number" name="CCV_Code" maxlength="3" class="form-control"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div><small class="airport">Soekarno Hatta Intl Airport</small>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div><small class="airport">Doha Hamad International Airport</small>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
